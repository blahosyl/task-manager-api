"""
Django settings for api_task_manager project.
...
# get local env.py file if it exists
...
SECRET_KEY = 'django-insecure-fv%6*l#jmtt&trqo$lnm19dv)8fsr#0(tg(ikk_oj0oply5%+7'
